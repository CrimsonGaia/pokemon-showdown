...
export const Formats: import('../sim/dex-formats').FormatList = [
	//#region IS FORMATS
	{ section: "Indigo Starstorm League", },
	{
		name: "ISL Regulation Set α [Alpha]",
		...
		ruleset: [  
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'First Stage Only', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
			'Max Team Size = 10', 'Picked Team Size = 6', 'Adjust Level = 20',
		],
		unbanlist: ['Cosmog', 'Kubfu', 'Type: Null', 'Poipole'],
	},
	{
		name: "ISL Regulation Set Δ [Delta]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'First or Second Stage', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
	...
	{
		name: "ISL Regulation Set ι [Iota]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Single Stage Only', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
	...
	{
		name: "ISL Regulation Set β [Beta]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
			'Max Team Size = 10', 'Picked Team Size = 6', 'Adjust Level = 50',
		],
		banlist: ['Legendary', 'Mythical', 'Restricted Legendary', 'Restricted Mythical', 'Paradox', 'Restricted Paradox'],
		unbanlist: ['Cosmog', 'Cosmoem', 'Kubfu', 'Type: Null', 'Poipole'],
	},
	{
		name: "ISL Regulation Set ζ [Zeta]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Paradox Allowed', 'Limit Paradox = 3', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
			'Max Team Size = 10', 'Picked Team Size = 6', 'Adjust Level = 60',
		],
		banlist: ['Legendary', 'Mythical', 'Restricted Legendary', 'Restricted Mythical'],
	},
	{
		name: "ISL Regulation Set γ [Gamma]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Paradox Allowed', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
			'Max Team Size = 10', 'Picked Team Size = 6', 'Adjust Level = 70',
		],
	},
	{
		name: "ISL Regulation Set Θ [Theta]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
	...
	{
		name: "ISL Regulation Set ε [Epsilon]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
	...
	{
		name: "ISL Regulation Set λ [Lambda]",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Limit Restricted Indigo = 1', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
	...
	},
	{
		...
		ruleset: [
			'Indigo Starstorm Timer', 'Indigo Starstorm Whitelist', 'Limit Restricted Indigo = 2', 'Item Reveal', 'Obtainable', 'Team Preview', 'HP Percentage Mod', 'Cancel Mod',
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause',
			'Max Team Size = 10', 'Picked Team Size = 6', 'Adjust Level = 100',
		],
		banlist: ['Restricted Mythical', 'Mythical'],
	...
	{ section: "IS Custom Game", },
	{
		...
		ruleset: [
			...
			'Freeze Clause', 'Item Clause = 1', 'Level Clause', 'Species Clause', 'Tera Clause', 'Endless Battle Clause',
		],
	},
	{
		name: "Indigo Starstorm Doubles",
		mod: 'gen9indigostarstorm',
		gameType: 'doubles',
	...
	{
		name: "4v4 Doubles Draft",
		mod: 'gen9',
		gameType: 'doubles',
		searchShow: false,
		bestOfDefault: true,
		teraPreviewDefault: true,
		ruleset: ['Standard Draft', 'Item Clause = 1', 'VGC Timer', 'Adjust Level = 50', 'Picked Team Size = 4', 'Min Source Gen = 9'],
	},
	...
	},
	{
		...
		mod: 'gen9',
		ruleset: ['Standard OMs', 'Godly Gift Mod'],
		banlist: [
			'Blissey', 'Calyrex-Shadow', 'Chansey', 'Deoxys-Attack', 'Koraidon', 'Kyurem-Black', 'Miraidon', 'Arena Trap', 'Gale Wings', 'Huge Power', 'Pure Power', 'Shadow Tag',
	...
	},
	{
		...
		mod: 'gen9',
		searchShow: false,
		ruleset: ['Standard OMs', 'Inverse Mod', 'Terastal Clause'],
		banlist: [
			...
			'Spectrier', 'Ursaluna', 'Ursaluna-Bloodmoon', 'Zacian', 'Zacian-Crowned', 'Zamazenta-Hero', 'Zekrom', 'Arena Trap', 'Shadow Tag', 'King\'s Rock', 'Light Clay',
	...
	},
	{
		...
		banlist: [
			...
			'Reshiram', 'Shaymin-Sky', 'Sneasler', 'Solgaleo', 'Terapagos', 'Volcarona', 'Zacian-Crowned', 'Zamazenta-Crowned', 'Arena Trap','Shadow Tag',
		...
		onModifyMove(move, pokemon, target) {
			...
			if (specialTypes.includes(move.type)) { move.category = 'Special'; } 
			else if (move.type === 'Stellar') { move.category = pokemon.getStat('atk', false, true) > pokemon.getStat('spa', false, true) ? 'Physical' : 'Special'; } 
