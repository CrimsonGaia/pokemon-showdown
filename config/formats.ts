...
export const Formats: import('../sim/dex-formats').FormatList = [
	...
	{ section: "ISL Formats", },
	{
		...
		ruleset: [  
			...
			'Species Clause', 'Nickname Clause', 'Item Clause = 1', 'Endless Battle Clause', 'Sleep Clause Mod',
	...
	{ section: "IS Custom Game", },
	{
		...
		ruleset: [
			...
			'Freeze Clause', 'Item Clause = 1', 'Level Clause', 'Species Clause', 'Tera Clause', 'Endless Battle Clause', 'Sleep Clause Mod',
		],
	},
	{
	...
	},
	{
		...
		searchShow: false,
		teraPreviewDefault: true,
		ruleset: ['Standard Draft', '!Sleep Clause Mod', 'Min Source Gen = 9'],
	},
	{
		...
		bestOfDefault: true,
		teraPreviewDefault: true,
		ruleset: ['Standard Draft', 'Item Clause = 1', 'VGC Timer', '!Sleep Clause Mod', 'Adjust Level = 50', 'Picked Team Size = 4', 'Min Source Gen = 9'],
	},
