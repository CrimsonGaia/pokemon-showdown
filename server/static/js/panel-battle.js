...
if(PS.prefs.bwgfx){Dex.loadSpriteData('bw');}return _this;
...
refresh=function refresh(){PS.send("/cmd roomlist "+toID(this.format)+", "+this.filters);};return BattlesRoom;}(PSRoom);var
...
refresh=function(){_this2.props.room.refresh();};_this2.
...
preact.h("div",{"class":"list"},!room.battles?preact.h("p",null,"Loading..."):!room.battles.length?preact.h("p",null,"No battles are going on"):preact.h(preact.Fragment,null,
...
_this5.update(null);
}catch(_unused){_this5.receiveLine(['error','Battle not found']);}
});
...
shouldComponentUpdate=function shouldComponentUpdate(){return false;};_proto4.
componentDidMount=function componentDidMount(){
var room=this.props.room;
if(room.battle){this.base.replaceChild(room.battle.scene.$frame[0],this.base.firstChild);}
};_proto4.
render=function render(){return preact.h("div",null,preact.h("div",{"class":"battle"}));};return BattleDiv;}(preact.Component);var
...
var timerTicking=room.battle.kickingInactive&&room.request&&room.request.requestType!=="wait"&&room.choices&&!room.choices.isDone()?' timerbutton-on':'';
...
;var
TeraChargeButton=function(_preact$Component3){function TeraChargeButton(){return _preact$Component3.apply(this,arguments)||this;}_inheritsLoose(TeraChargeButton,_preact$Component3);var _proto6=TeraChargeButton.prototype;_proto6.
render=function render(){var _teraCharge,_teraChargeMax;
var battle=this.props.room.battle;


var cur=(_teraCharge=battle.teraCharge)!=null?_teraCharge:0;
var max=(_teraChargeMax=battle.teraChargeMax)!=null?_teraChargeMax:100;
...
preact.h("span",{"class":"teracharge-meter","aria-hidden":true},
preact.h("span",{"class":"teracharge-fill",style:{width:pct+"%"}})
),
preact.h("span",{"class":"teracharge-text"},
preact.h("i",{"class":"fa fa-diamond","aria-hidden":true})," Tera"
)
);
};return TeraChargeButton;}(preact.Component);
;var
...
team=null;_this8.
send=function(text,elem){_this8.props.room.send(text,elem);};_this8.
...
preact.h("div",{style:{position:"absolute",right:"10px",display:"flex",gap:"6px"}},
preact.h(TeraChargeButton,{room:room}),
