...
statusNames=['par','psn','tox','brn','frz','slp','aura','bubbleblight','curse','dragonblight','fear','frostbite','drowsy','confusion','flinch'];this.
...
str=str.replace(/\bhttps?:\/\/[^\s<>"']+/g,function(url){
