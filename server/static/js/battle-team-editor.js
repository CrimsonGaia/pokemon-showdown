...
var species=_this8.dex.species.get(set.species);
if(species.abilities){
var abilityId=toID(name);
var abilities=species.abilities;

var isInSet1=abilityId===toID(abilities['0'])||abilityId===toID(abilities['1']);
var isInSet2=abilityId===toID(abilities['H'])||abilityId===toID(abilities['S']);

if(isInSet2&&!isInSet1){

set.abilitySet=2;
set.ability2=abilities['S'];
}else{

set.abilitySet=1;
set.ability2=abilities['1'];
}
}
