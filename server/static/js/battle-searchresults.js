...
if(_this.props.onSelect){_this.props.onSelect==null||_this.props.onSelect('','');}else
if(search.query){
search.find('');
_this.forceUpdate();
}
}else{_this.props.onSelect==null||_this.props.onSelect(type,name,slot);}
ev.preventDefault();
...
componentDidMount=function componentDidMount(){this.componentDidUpdate();};_proto.
