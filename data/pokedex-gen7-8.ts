export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	alcremie: {
		...
		eggGroups: ["Fairy", "Amorphous"],
		otherFormes: ["Alcremie-Mega", "Alcremie-Ruby-Cream", "Alcremie-Matcha-Cream", "Alcremie-Mint-Cream", "Alcremie-Lemon-Cream", "Alcremie-Salted-Cream", "Alcremie-Ruby-Swirl", "Alcremie-Caramel-Swirl", "Alcremie-Rainbow-Swirl"],
