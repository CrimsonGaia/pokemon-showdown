export const Pokedex: import('../sim/dex-species').SpeciesDataTable = {
	...
	munna: {
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: { hp: 76, atk: 25, def: 45, spa: 77, spd: 77, spe: 24 },
		abilities: { // ABILITY SET 1
            0: "Telepathy",
            1: "Levitate",
                    // ABILITY SET 2
		...
		guardAction: ["aromaticmist", "teleport", "leap"],
		heightm: 0.6,
		weightkg: 23.3,
		color: "Pink",
		evos: ["Musharna"],
	...
	musharna: {
		...
		types: ["Psychic"],
		gender: "F",
		baseStats: { hp: 116, atk: 41, def: 87, spa: 114, spd: 116, spe: 13 },
		abilities: { // ABILITY SET 1
            0: "Telepathy",
            1: "Levitate",
                    // ABILITY SET 2
	...
	bouffalantpaldea: {
		num: 626,
		name: "Bouffalant-Paldea",
		types: ["Fighting"],
		baseStats: { hp: 80, atk: 102, def: 95, spa: 40, spd: 85, spe: 68 },
		abilities: { // ABILITY SET 1
            0: "Reckless",
            1: "Protective Pads",
                    // ABILITY SET 2
	...
	affrohm: {
		...
		gender: "M",
		baseStats: { hp: 95, atk: 102, def: 95, spa: 40, spd: 85, spe: 68 },
		abilities: { // ABILITY SET 1
            0: "Reckless",
            1: "Protective Pads",
                    // ABILITY SET 2
	...
	chandeluremega: {
		...
		forme: "Mega-X",
		types: ["Ghost", "Fire"],
		baseStats: { hp: 110, atk: 85, def: 90, spa: 175, spd: 90, spe: 70 },
		abilities: { 0: "Soul-Heart", 1: "Illuminate" },
		guardAction: [],
		heightm: 2.5,
		weightkg: 69.6,
		color: "Black",
