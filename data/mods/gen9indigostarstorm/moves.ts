...
export const Moves: import('../../../sim/dex-moves').ModdedMoveDataTable = {
	...
	bitterextract: {
		...
		desc: "Ignores resistances, but not immunities. Lowers the target's Special Defense by 2 stages and has a 30% chance to make the target Flinch.",
		shortDesc: "Ignores resistances. 100% -2 SpD; 30% flinch.",
		target: "normal",
	},
	bittermalice: {
		num: 841,
