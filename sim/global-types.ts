...
//region Battle
interface BattleScriptsData { gen: number; }
interface ModdedBattleActions {
	...
	useMove?: ( this: BattleActions, move: Move, pokemon: Pokemon, options?: { target?: Pokemon | null, sourceEffect?: Effect | null, zMove?: string, maxMove?: string, } ) => boolean;
	useMoveInner?: ( this: BattleActions, move: Move, pokemon: Pokemon, options?: { target?: Pokemon | null, sourceEffect?: Effect | null, zMove?: string, maxMove?: string, } ) => boolean;
...
interface ModdedBattlePokemon {
	...
	getMoves?: (this: Pokemon, lockedMove?: string | null, restrictData?: boolean) => { move: string, id: string, disabled?: string | boolean, disabledSource?: string, target?: string, pp?: number, maxpp?: number, }[];
